...
console.log("Good Job! You have Entered the currect Number") // when get the currect number than this message will be print
...
console.log("Mean of those numbers are: ", mean(1, 2, 3, 4, 5))
